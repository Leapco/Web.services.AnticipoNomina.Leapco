    ...
    public class Utilities
    {
        ...
        public async Task<bool> SendEmail(string toAddress, string subject, string body, bool IsBodyHtml, string? pdfFilePath)
        {
            ...
            try
            {
                ...
                //toAddress = "informatica5@gigha.com.co";
